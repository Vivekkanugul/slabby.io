  ...
  return (
    <div className="min-h-screen bg-[#050508] py-8" data-testid="razz-page">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            <h1 className="font-heading text-2xl font-medium text-white flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#BCFF00]/10 flex items-center justify-center">
                <Dice6 className="w-5 h-5 text-[#BCFF00]" />
              </div>
              Razz
            </h1>
          ...
          {isAuthenticated && (
            <div className="flex gap-2">
              <Button
                ...
                className={activeTab === 'browse' ? 'bg-[#BCFF00] text-black hover:bg-[#D4FF4D]' : 'border-white/10'}
              >
                Browse
              </Button>
              <Button
                ...
                className={activeTab === 'my-razzes' ? 'bg-[#BCFF00] text-black hover:bg-[#D4FF4D]' : 'border-white/10'}
              >
                My Entries
              </Button>
            </div>
        ...
        {/* Provably Fair Info */}
        <div className="bg-[#0A0A0E] border border-[#BCFF00]/20 rounded-xl p-4 mb-8 flex items-start gap-3">
          <Shield className="w-5 h-5 text-[#BCFF00] mt-0.5" />
          <div>
            ...
            {razzes.length === 0 ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {razzes.map((razz) => (
                  <div
                    key={razz.id}
                    className="bg-[#0A0A0E] border border-white/10 rounded-xl overflow-hidden hover:border-[#BCFF00]/30 transition-all cursor-pointer"
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <div className="h-2 bg-[#121216] rounded-full overflow-hidden">
                        <div 
                          className="h-full bg-gradient-to-r from-[#BCFF00] to-[#9FD900] transition-all"
